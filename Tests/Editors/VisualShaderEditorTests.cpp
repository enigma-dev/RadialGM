...
void TestVisualShaderEditor::test_create_full_graph() {
...

  {
    ...
    QVERIFY(embed_widget != nullptr);
    VisualShaderNodeFloatFuncEmbedWidget* sin_embed_widget {dynamic_cast<VisualShaderNodeFloatFuncEmbedWidget*>(embed_widget)};
...

  {
    ...
    QVERIFY(embed_widget != nullptr);
    VisualShaderNodeFloatOpEmbedWidget* divide_embed_widget {dynamic_cast<VisualShaderNodeFloatOpEmbedWidget*>(embed_widget)};
