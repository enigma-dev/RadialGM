...
VisualShaderNodeEmbedWidget::VisualShaderNodeEmbedWidget(const std::shared_ptr<VisualShaderNode>& node, 
  ...
  if (auto p {std::dynamic_pointer_cast<VisualShaderNodeInput>(node)}) {
    ...
    VisualShaderNodeVoronoiNoiseAngleOffsetEmbedWidget* embed_widget = new VisualShaderNodeVoronoiNoiseAngleOffsetEmbedWidget(p);
    VisualShaderNodeVoronoiNoiseCellDensityEmbedWidget* embed_widget2 = new VisualShaderNodeVoronoiNoiseCellDensityEmbedWidget(p);
    layout->addWidget(embed_widget);
...
VisualShaderNodeValueNoiseEmbedWidget::VisualShaderNodeValueNoiseEmbedWidget(const std::shared_ptr<VisualShaderNodeValueNoise>& node) : QLineEdit(), 
                                                                                                                                   node(node) {
  setSizePolicy(QSizePolicy::Minimum, QSizePolicy::Minimum);
  setContentsMargins(0, 0, 0, 0);  // Left, top, right, bottom
...
VisualShaderNodePerlinNoiseEmbedWidget::VisualShaderNodePerlinNoiseEmbedWidget(const std::shared_ptr<VisualShaderNodePerlinNoise>& node) : QLineEdit(), 
                                                                                                                                   node(node) {
  setSizePolicy(QSizePolicy::Minimum, QSizePolicy::Minimum);
  setContentsMargins(0, 0, 0, 0);  // Left, top, right, bottom
...
VisualShaderNodeVoronoiNoiseAngleOffsetEmbedWidget::VisualShaderNodeVoronoiNoiseAngleOffsetEmbedWidget(const std::shared_ptr<VisualShaderNodeVoronoiNoise>& node) : QLineEdit(), 
                                                                                                                                   node(node) {
  setSizePolicy(QSizePolicy::Minimum, QSizePolicy::Minimum);
  setContentsMargins(0, 0, 0, 0);  // Left, top, right, bottom
...
VisualShaderNodeVoronoiNoiseCellDensityEmbedWidget::VisualShaderNodeVoronoiNoiseCellDensityEmbedWidget(const std::shared_ptr<VisualShaderNodeVoronoiNoise>& node) : QLineEdit(), 
                                                                                                                                   node(node) {
  setSizePolicy(QSizePolicy::Minimum, QSizePolicy::Minimum);
  setContentsMargins(0, 0, 0, 0);  // Left, top, right, bottom
